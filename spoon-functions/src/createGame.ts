...
export const createGame = async (data: any, context: any) => {
  ...
  // Set Players
  const setPlayers: { [x: string]: { Name: any; Score: number; Status: boolean } } = {};
  ...
  const mytoken =
    "e8A9vmcyTEMMpQbUPM9LPq:APA91bHHE6Rmj4tQchm9ardhhuWzAh463WvBR82R8ZxujkShMyawstC0Uh1nc8OifdO1RdQNAuveLpfDroS3KYgKHNOXp1Zrcbfb92PAbKYrzC_tFHS9BiKJ188UiJ6G93PfbIizxZH4";
